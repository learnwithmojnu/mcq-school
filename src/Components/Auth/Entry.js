                ...
                auth.user ?
                    <div className="userSignedIn">
                        <div className="userInfo">
                            {
                                auth.user.photo ?
                                    <incorrect_answers src={auth.user.photo} alt={auth.user.name} style={{ width: "150px", borderRadius: "50%" }} /> :
                    ...
                    <div className="accountWrapper d-flex justify-content-center align-items-center">
                        <div className="alert">
                        ...
                        <div className="signArea row" id="signArea">
                            <div className="loginSocialNetworks col-md-6">
